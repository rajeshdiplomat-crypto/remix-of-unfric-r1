  ...
  return (
    <>
      ...
      <div className="flex flex-col w-full h-full bg-background antialiased overflow-hidden min-h-0">
        <div className="flex-1 flex flex-col lg:flex-row gap-0 w-full max-w-[1400px] mx-auto min-h-0 overflow-hidden">
          {/* ========== LEFT COLUMN: Editorial + Vision Board (desktop only) ========== */}
           <div className="hidden lg:flex flex-col min-h-0 overflow-hidden" style={{ width: '40%', height: '100%' }}>
          ...
          <div className="flex flex-col min-h-0 overflow-hidden lg:flex-1" style={{ height: '100%' }}>
