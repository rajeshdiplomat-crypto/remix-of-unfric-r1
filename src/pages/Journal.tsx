    ...
    <div className="flex flex-col w-full h-full overflow-hidden">
      ...
      {!isFullscreen && (
        <>
          ...
          />
          {journalHeader}
          <div className="flex-1 min-h-0 grid gap-6 lg:gap-12 w-full px-3 sm:px-6 lg:px-8 py-4 sm:py-8 overflow-hidden grid-cols-1 lg:grid-cols-[1fr_2fr] max-w-[1200px] mx-auto">
