...
export default function Diary() {
  ...
  return (
    ...
    >
      ...
      {/* Right Sidebar */}
      <aside className="hidden md:flex flex-col w-[280px] xl:w-[340px] shrink-0 h-full min-h-0 overflow-y-auto border-l border-border/20 bg-background/50 p-4 gap-4">
        <DiaryProfileCard
          userName={userName}
