        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
              ...
              <Card className="rounded-2xl border-border shadow-sm overflow-hidden h-[520px] flex flex-col">
              ...
              <Card className="rounded-2xl border-border shadow-sm h-[520px] flex flex-col">
