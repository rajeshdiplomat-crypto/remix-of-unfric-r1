...
// Rotating quotes about emotional awareness
const QUOTES = [
  "Understanding your emotions helps you navigate life with greater intention.",
  "Every feeling is a message—listen closely.",
  "Emotional awareness is the foundation of inner peace.",
  "Your patterns reveal insights about what influences your mood.",
];
              ...
              <div className="flex-1 overflow-y-auto">
                ...
                <div className="p-4 border-b border-border/30">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-sm">Emotion Check-in</h3>
                      <p className="text-[10px] uppercase tracking-wider text-muted-foreground flex items-center gap-1">
                        <Sparkles className="h-3 w-3" />
                        Clarity Through Awareness
                      </p>
                    </div>
                  </div>
                  ...
                  <p className="text-xs text-muted-foreground mb-4 leading-relaxed">
                    Track how you feel across the energy and pleasantness spectrum. 
                    Your patterns reveal insights about what influences your mood.
                  </p>
