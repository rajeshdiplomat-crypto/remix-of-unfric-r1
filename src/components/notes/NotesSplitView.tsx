    ...
    <div className="w-full h-[calc(100vh-80px)] p-4">
      <div className="h-full border border-slate-200 rounded-xl overflow-hidden bg-white shadow-sm relative">
        <ResizablePanelGroup direction="horizontal" className="h-full">
          {/* Left Sidebar */}
          <ResizablePanel defaultSize={20} minSize={12} maxSize={40} className="border-r border-slate-100 flex flex-col bg-slate-50 overflow-visible relative z-[10000]">
          ...
          <ResizableHandle withHandle className="bg-slate-100 hover:bg-primary/20 transition-colors" />

          {/* Right Panel - Editor */}
          <ResizablePanel defaultSize={80} minSize={50} className="flex flex-col min-w-0 overflow-hidden relative z-0">
            {selectedNote ? (
            <>
