...
export function NotesRichEditor({
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      {/* Compact Toolbar */}
      <div className="sticky top-0 z-40 bg-muted/50 backdrop-blur border-y overflow-x-auto">
        <div className="flex items-center gap-0.5 px-4 py-1.5 min-w-max">
          ...
          >
            <SelectTrigger className="w-20 h-7 text-xs border-0 bg-background">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              {FONT_FAMILIES.map((f) => (
          ...
          >
            <SelectTrigger className="w-14 h-7 text-xs border-0 bg-background">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              {FONT_SIZES.map((s) => (
          ...
          <Button
            variant="outline"
            size="sm"
            className="h-7 gap-1 text-xs bg-violet-50 border-violet-200 text-violet-700"
