...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "rounded-full bg-primary text-primary-foreground hover:bg-primary/90 hover:-translate-y-0.5 hover:shadow-md",
        ...
        chip: "rounded-full bg-muted/15 text-foreground border border-border/30 hover:bg-muted/25 font-normal",
        chipActive: "rounded-full bg-primary/15 text-primary border border-primary/30 hover:bg-primary/20 font-normal",
      },
      size: {
