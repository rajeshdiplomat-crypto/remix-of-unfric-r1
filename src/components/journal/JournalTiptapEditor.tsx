      ...
      extensions: [
        ...
        Placeholder.configure({
          placeholder: ({ node }) => {
            ...
            return "Start writing your journal entry...";
          },
        }),
    ...
    return (
      ...
      >
        ...
        <style>{`
          ...
          .ProseMirror h2 { font-size: 1.5em; color: ${skinStyles?.text || "inherit"}; }
          ...
          .ProseMirror ul[data-type="taskList"] li input { margin-top: 0.25rem; cursor: pointer; accent-color: hsl(var(--primary)); }
          .ProseMirror ul[data-type="taskList"] li[data-checked="true"] > div { text-decoration: line-through; opacity: 0.6; }
