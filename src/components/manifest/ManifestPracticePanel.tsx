...
export interface ManifestDailyPractice {
  ...
  acts: ActEntry[];
  proofs: ProofEntry[];
  gratitudes?: GratitudeEntry[]; // Multiple gratitude entries

  // Section 2 - Daily Check-in
  alignment?: number; // 1-10
  growth_note?: string;
  gratitude?: string; // Legacy single gratitude field
...
export const STARTER_TEMPLATES: StarterTemplate[] = [
  {
    ...
    visualization_script:
      "See yourself on day one of your dream role. Feel the confidence as you walk through the door.",
